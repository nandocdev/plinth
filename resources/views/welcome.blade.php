                ...
                <div class="container mx-auto px-6 relative z-10 text-center">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
                        ...
                        <flux:button href="https://github.com" target="_blank" variant="subtle"
                            class="!px-8 !py-4 !text-lg !font-semibold border border-white/10 hover:bg-white/5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="mr-2 lucide lucide-github">
                                <path
                        ...
                        <div
                            ...
                            <div class="p-8 md:p-12 w-full h-full flex flex-col justify-between text-left">
                                <div class="flex items-center justify-between mb-8">
                                    ...
                                    <div
                                        class="px-3 py-1 rounded bg-white/5 border border-white/5 text-[10px] uppercase tracking-widest font-bold text-white/40">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 flex-grow">
                                    ...
                                    <div
                                        ...
                                        <div class="w-10 h-10 rounded bg-indigo-600 flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="text-white lucide lucide-users">
                                    ...
                                    <div class="p-6 rounded-lg border border-white/5 bg-white/5 flex flex-col gap-4">
                                        <div
                                            class="w-10 h-10 rounded bg-violet-600/20 flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="text-violet-500 lucide lucide-credit-card">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-4">
                                        <span class="flex items-center gap-1 text-green-500/80"><span
                                                class="w-1.5 h-1.5 rounded-full bg-green-500"></span> PostgreSQL
                                            Connected</span>
                                        <span>v1.0.0</span>
                                    </div>
                                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-command">
                                    <path
                                        d="M15 6a3 3 0 1 0-6 0 3 3 0 0 0 6 0Zm0 12a3 3 0 1 0-6 0 3 3 0 0 0 6 0ZM6 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm12 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z" />
                                </svg>
                            </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-puzzle">
                                    <path
                                        d="M12 8a.5.5 0 0 1 .5.5v1.5a.5.5 0 0 0 .5.5h1.5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1.5a.5.5 0 0 0-.5.5v1.5a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1.5a.5.5 0 0 0-.5-.5h-1.5a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 0 .5-.5V8.5a.5.5 0 0 1 .5-.5z" />
                                    <path d="M10 2H8a2 2 0 0 0-2 2v2" />
                                    <path d="M2 8v2a2 2 0 0 0 2 2h2" />
                                    <path d="M14 2h2a2 2 0 0 1 2 2v2" />
                                    <path d="M22 8v2a2 2 0 0 1-2 2h-2" />
                                    <path d="M10 22H8a2 2 0 0 1-2-2v-2" />
                                    <path d="M2 14v2a2 2 0 0 1 2 2h2" />
                                    <path d="M14 22h2a2 2 0 0 0 2-2v-2" />
                                    <path d="M22 14v2a2 2 0 0 0-2 2h-2" />
                                </svg>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">Gestión de la plataforma, registro de usuarios, billing
                                            global y administración del sistema.</p>
                                    </div>
                                </div>
                                <div class="flex gap-4">
                                    <div
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">El "espacio de trabajo" aislado para tus clientes.
                                            Totalmente separado a nivel lógico y de datos.</p>
                                    </div>
                                </div>
                                <div class="flex gap-4">
                                    <div
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">Contratos, DTOs y utilidades compartidas entre ambos
                                            contextos de forma segura.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    └── Support/
            ...
            <section id="pricing" class="py-24 bg-zinc-950/50">
                <div class="container mx-auto px-6">
                    ...
                    @php
                        $featureLabels = [
                            'dashboard_basic' => 'Dashboard completo',
                        ...
                        $popularSlug = 'growth';
                        $allSlugs = $plans->pluck('slug')->all();
                        // Use the middle plan as popular if 'growth' doesn't exist
                        if (!in_array($popularSlug, $allSlugs, true) && count($allSlugs) > 0) {
                            $popularSlug = $allSlugs[(int) floor(count($allSlugs) / 2)];
                        }
                    @endphp

                    <div
                        class="grid grid-cols-1 md:grid-cols-{{ min(count($plans), 3) }} gap-8 max-w-6xl mx-auto items-stretch">
                        @foreach ($plans as $plan)
                            @php $isPopular = $plan->slug === $popularSlug; @endphp
                            ...
                            <div @class([
                                ...
                                @else
                                    <flux:button href="/signup?plan={{ $plan->slug }}" variant="subtle"
                                        class="w-full border-white/10 hover:bg-white/5">Elegir {{ $plan->name }}
                                    </flux:button>
                                @endif
                            </div>
                        @endforeach
